...
Real-world **advisor** sessions demonstrating the full deliberation process and verdict output format. For **researcher** examples see [`research.md`](research.md); for the chained flow see [`chained.md`](chained.md).
